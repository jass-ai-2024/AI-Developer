...
from hcp.topo import RepoTopo
from hcp.retriever import AutoRetriever
...
def main():
    ...
    file_node = repo_topo.file_nodes.get(args.file)
    if file_node is None:
        print(f"File {args.file} not found in file_nodes.")
        return
